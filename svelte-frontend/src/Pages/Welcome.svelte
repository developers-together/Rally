...
<svelte:head>
  <title>Platform-IO — Where Ideas Sync, Teams Thrive</title>
  <meta name="description" content="Your All-in-One Hub for Smarter Collaboration. Platform-IO brings teams together with chat, tasks, calendar, files, and AI." />
</svelte:head>
...
<div class="start5">
  ...
  <div class="starter-page5">
    <div class="starter-content5">
      ...
      >
        <a href="/login" class="btn-custom5">
